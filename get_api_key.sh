...
Notes:
  - obtains and sets LITELLM_API_KEY in your $BASH_PROFILE as environment variable
...
echo ""
echo "########### TODO ##########"
echo ">>> 1. add the following to your devcontainer.env:   LITELLM_API_KEY=${key_value}"
echo ">>> 2. Restart your shell session OR run 'source $BASH_PROFILE' to load the new API key into your environment."
echo ">>> 3. Run:  ccr restart"
echo ">>> 4. Run:  claude -p \"Say Hello!\" "
echo ""
