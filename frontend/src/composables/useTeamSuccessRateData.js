...
export function useTeamSuccessRateData() {
  ...
  async function fetchData(startDate, endDate) {
    ...
    try {
      let url = `${backendURL}/tokens/success-rate`
      ...
      successRateData.value = data.teams || []
    } catch (err) {
      error.value = err.message || 'Failed to fetch success rate data'
